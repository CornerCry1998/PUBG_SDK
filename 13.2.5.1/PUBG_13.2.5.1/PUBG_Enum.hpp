...
{
	EGraphicsAPIType__DX11         = 0,
	EGraphicsAPIType__DX11_Enhanced = 1,
	EGraphicsAPIType__DX12         = 2,
	EGraphicsAPIType__EGraphicsAPIType_MAX = 3
};
...
enum class EGuideKeyType : uint8_t
{
	...
	EGuideKeyType__PickUpAndHoldQuickEquip = 3,
	EGuideKeyType__Unequip         = 4,
	EGuideKeyType__DetachAll       = 5,
	EGuideKeyType__DetachAndDetachAll = 6,
	EGuideKeyType__Drop            = 7,
	EGuideKeyType__DropWeapon      = 8,
	EGuideKeyType__DropAndDropAmount = 9,
	EGuideKeyType__DropAndDropWeapon = 10,
	EGuideKeyType__DropWeaponAndWeaponToTrunk = 11,
	EGuideKeyType__DropAndDropWeaponAndMoveToTrunk = 12,
	EGuideKeyType__DropFromTrunk   = 13,
	EGuideKeyType__Equip           = 14,
	EGuideKeyType__EquipAndMoveToTrunk = 15,
	EGuideKeyType__XQuickEquip     = 16,
	EGuideKeyType__Swap            = 17,
	EGuideKeyType__SwapWeapon      = 18,
	EGuideKeyType__SwapAndMoveToTrunk = 19,
	EGuideKeyType__Use             = 20,
	EGuideKeyType__UseAndMoveToTrunk = 21,
	EGuideKeyType__Confirm         = 22,
	EGuideKeyType__Cancel          = 23,
	EGuideKeyType__SwitchSlot      = 24,
	EGuideKeyType__Apply           = 25,
	EGuideKeyType__QuickPickUp     = 26,
	EGuideKeyType__QuickPickUpAndVicinityToTrunk = 27,
	EGuideKeyType__QuickPickUpAndDropFromTrunk = 28,
	EGuideKeyType__QuickDrop       = 29,
	EGuideKeyType__SwitchSlotAndSwapWeapon = 30,
	EGuideKeyType__MoveToTrunk     = 31,
	EGuideKeyType__VicinityToTrunk = 32,
	EGuideKeyType__Purchase        = 33,
	EGuideKeyType__EGuideKeyType_MAX = 34
};
...
{
	EBlueBallProjectile_State__Deactivated = 0,
	EBlueBallProjectile_State__Raising = 1,
	EBlueBallProjectile_State__Resting = 2,
	EBlueBallProjectile_State__MovingToCenter = 3,
	EBlueBallProjectile_State__MovingToCenterAndSearch = 4,
	EBlueBallProjectile_State__Homing = 5,
	EBlueBallProjectile_State__EBlueBallProjectile_MAX = 6
};
...
{
	EInventoryListPackageType__CarePackage = 0,
	EInventoryListPackageType__InventoryOrDeathDropPackage = 1,
	EInventoryListPackageType__TrunkPackage = 2,
	EInventoryListPackageType__ItemPackage = 3,
	EInventoryListPackageType__Ground = 4,
	EInventoryListPackageType__Max = 5,
	EInventoryListPackageType__EInventoryListPackageType_MAX = 6
};
...
enum class EValueCompareFunc : uint8_t
{
	...
	EValueCompareFunc__NotEqual    = 5,
	EValueCompareFunc__EValueCompareFunc_MAX = 6
};
...
{
	EPercivedGrenadeType__FragGrenade = 0,
	EPercivedGrenadeType__StickyBomb = 1,
	EPercivedGrenadeType__C4       = 2,
	EPercivedGrenadeType__EPercivedGrenadeType_MAX = 3
};
...
{
	EEnemyCompareElement__None     = 0,
	EEnemyCompareElement__HouseId  = 1,
	EEnemyCompareElement__EEnemyCompareElement_MAX = 2
};
